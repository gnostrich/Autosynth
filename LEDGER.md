...
- **2026-08-14 — fieldscrubleans-unregistered-cell-writer**: commit f0db9d3 ('TRACKS: restore the cell steering component the click used to send') shipped an unregistered A/B onto Amendment 2's columns-only fieldScrubLeans(mag, w): changed the signature to fieldScrubLeans(tid, mag, w) and emitted BOTH ['role', tid, r] (CELL, casting/pick lane) and ['col', r] (COLUMN, settlement lane) from a single click, putting a second writer on the (track,role) cell lane WS-9/WS-10 (papers/PREREG-waveform-scrub.md) give exactly one owner (the GRID cell gesture). The commit's own diagnosis was correct and disclosed in its message — 'a settlement column lean is soft by construction and does nothing at all on a region-disarmed corpus' — but instead of surfacing that wall (per the standing walls-are-surfaced-not-patched rule) it silently routed around it by bolting on the stronger CELL channel. It also stacked a new comment ('RESTORED CELL COMPONENT...') directly beneath the original 'TRACK ID IS NOT AN ARGUMENT — this function structurally cannot write a per-track lean' comment without removing the now-false original, leaving both present and contradictory. REVERTED per operator ruling 2026-08-14: fieldScrubLeans back to the 2-argument columns-only form (matching origin/main byte-for-byte in that region), the 'RESTORED CELL COMPONENT' comment removed, the original 'TRACK ID IS NOT AN ARGUMENT' comment intact and now true again. Verified: cloud/tests/test_waveform_scrub_fe.py went from 9 failed/36 passed (HEAD, with the hunk) to 45 passed/0 failed (after revert). fieldRoleStripMarks (D-1 strip's 'YOUR LEAN' readout) was re-checked against the MISLABEL rule: it already sources force from st.bias[['col',r]] only, which under-reported while the click also wrote a cell entry; after the revert the click writes col only, so the readout is exact again — no separate code change needed there. The wall itself is written up with numbers (not just recalled from the commit message) at papers/FINDING-column-lean-region-disarmed-corpus.md: on demo.etsworld under a region-disarmed sigma clone (the same technique cloud/tools/track_role_grid_verify.py's ratified gate already uses), COLUMN's pushed value is bit-identical to its own baseline to 15 decimal places (0.536458333333333...) while CELL moves two orders of magnitude (0.000326 damped / 0.150798 base / 0.479248 amplified) under the identical disarmed sigma. NOTE (same class of risk the 2026-08-13 restoration below already flagged): this line was added BY HAND to LEDGER.md, not via scripts/build_ledger.py — running that generator would have silently dropped this line (and the 2026-08-13 block below) again, since neither is sourced from VERSION_LEDGER.jsonl's per-edit trail. LEDGER_DATA.json's `incidents` array was also updated with the matching entry (id fieldscrubleans-unregistered-cell-writer) so the generator picks it up on a future regen, but the generator's drop-on-regen bug for hand-added blocks is still unfixed.

## Engine-edit disclosures (undisclosed-at-landing, on the record)

- **2026-08-14 — live-mode-two-engine-edits-undisclosed-at-landing**: Two edits to architecture-v6/ets/writer/ landed on 2026-08-14 with no accompanying prereg/REGISTRY/LEDGER entry, though every cloud/-tree edit made that same day (across the parallel worktrees active that day) DOES appear in VERSION_LEDGER.jsonl's per-edit trail — neither architecture-v6/ets/writer/clamp.py nor realize.py shows an entry there for either edit. (1) commit 7e7b8af (13:34:33Z), 'LIVE: pin each slot to its own moment of the passage': ClampTerms gains slot_pin (a new field), and realize.py::_admits gains a THIRD comparison clause (after the track_mask/openness test and the unit_pin test), threaded through _choose/_choose_original/_choose_fast/place_slot. Fixes a measured self-mixing bug (one bar drew tatums 0, 8, 15, 16, 23 at once). This edit is a third comparison where papers/PREREG-live-mode.md §2.1 registers ClampTerms's restriction as ONE comparison and calls _admits 'the only engine logic ClampTerms adds' — both now false. Documented retroactively at papers/PREREG-live-mode.md#slot_pin--undisclosed-engine-edit-retroactive-disclosure-2026-08-14 and REGISTRY.jsonl id live-mode-slot-pin-undisclosed-2026-08-14, kind engine-edit-pending-ratification. STATUS: AWAITING OPERATOR RATIFICATION, not ratified as of this writing (2026-08-14). Byte-identity proven when slot_pin is absent (hash 22d27d511b433c86... unchanged with the clause present-but-unused vs. physically removed, across 16 bars / 4 fence configurations); this proves the neutral law, not that the comparison set is unchanged when slot_pin is supplied, which it now is on every LIVE straight-play bar. (2) commit 41fa549 (15:35:27Z), 'Close the two unfenced-cast holes: a fenced passage stays on its own tracks': fences the degenerate early-return branch in both choosers so no cast escapes ClampTerms via that path. Flagged inline at papers/PREREG-live-mode.md §BS.1(a) as 'ENGINE-FILE EDIT, FLAGGED FOR RATIFICATION' at the time it landed, and IS ratified. Standing rule issued after the slot_pin gap surfaced: any change to a carrier's TYPE, or to the comparison set of _admits, is an engine edit requiring prereg + REGISTRY + ratification REGARDLESS OF NEUTRALITY — one silent edit of this shape makes every 'no engine changes' claim in the project unverifiable by inspection. NOTE: this LEDGER_DATA.json key is not yet rendered into LEDGER.md by scripts/build_ledger.py (a code change, out of scope for the DOCS-ONLY pass that added this entry); the matching prose below the Incidents section was added to LEDGER.md by hand and will need to be re-added, or the generator extended, if LEDGER.md is regenerated from this data file before the generator is updated.
...
### at `a41453a`
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/engine_bridge.py (2026-07-18T11:30:54+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/engine_bridge.py (2026-07-18T11:31:10+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/engine_bridge.py (2026-07-18T11:31:23+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/engine_bridge.py (2026-07-18T11:31:40+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/tests/test_eigenpanel.py (2026-07-18T11:31:52+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:33:12+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:33:29+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:34:18+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:34:30+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:34:48+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:34:53+00:00)
- `Edit` cloud/companion/app.py (2026-07-18T11:35:31+00:00)
- `Edit` cloud/companion/app.py (2026-07-18T11:35:38+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:37:08+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:38:35+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:40:14+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:40:34+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:40:45+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:41:10+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:41:32+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:41:39+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:42:21+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:42:46+00:00)

### at `db591f5`
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:43:27+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:43:43+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:44:02+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:44:40+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:45:12+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:45:24+00:00)
...
### at `f6da403`
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:50:50+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:50:58+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/companion/static/index.html (2026-07-18T11:51:10+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/tests/test_fe_render_smoke.py (2026-07-18T11:51:51+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/tests/test_fe_render_smoke.py (2026-07-18T11:51:59+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/tests/test_fe_render_smoke.py (2026-07-18T11:52:06+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/tests/test_fe_render_smoke.py (2026-07-18T11:52:11+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/tests/test_fe_render_smoke.py (2026-07-18T11:52:17+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/tests/test_fe_render_smoke.py (2026-07-18T11:52:25+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/tests/test_web_fab_guard.py (2026-07-18T11:52:48+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/tests/test_web_fab_guard.py (2026-07-18T11:53:06+00:00)
- `Edit` .claude/worktrees/agent-af2e76bb781c1f76e/cloud/tests/test_cold_start.py (2026-07-18T11:53:57+00:00)
...
### at `6944953`
- `Edit` cloud/companion/static/index.html (2026-07-18T12:49:09+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T12:49:12+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T12:49:22+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T12:49:28+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T12:49:33+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T12:49:38+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T12:49:45+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T12:49:54+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T12:50:05+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T12:50:11+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T12:50:18+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T12:50:25+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T12:51:10+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T12:51:16+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T12:51:20+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T12:51:30+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T12:51:40+00:00)
...
### at `607fc0f`
- `Edit` cloud/companion/engine_bridge.py (2026-07-18T13:56:53+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-18T13:57:00+00:00)
- `Edit` cloud/REGRESSION-GUARDRAILS.md (2026-07-18T14:00:03+00:00)
...
### at `b86c6d7`
- `Edit` cloud/companion/eigen_experimental.py (2026-07-18T18:39:10+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-18T18:40:43+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-18T18:40:55+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-18T18:41:06+00:00)
- `Edit` cloud/companion/app.py (2026-07-18T18:41:30+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T18:42:30+00:00)
...
### at `f191fc7`
- `Edit` cloud/companion/static/index.html (2026-07-18T19:05:54+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-18T19:06:16+00:00)

### at `afeec39`
- `Edit` cloud/companion/engine_bridge.py (2026-07-18T19:41:24+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-18T19:41:40+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-18T19:42:03+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-18T19:42:46+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-18T19:42:52+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-18T19:42:59+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-18T19:43:11+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-18T19:43:23+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-18T19:46:31+00:00)
- `Edit` papers/PREREG-temperature-sweep.md (2026-07-18T19:49:34+00:00)
...
### at `59d91dc`
- `Edit` cloud/companion/app.py (2026-07-19T13:01:03+00:00)
- `Edit` cloud/tests/test_web_fab_guard.py (2026-07-19T13:01:20+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-19T13:02:48+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-19T13:03:16+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-19T13:03:40+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-19T13:03:54+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-19T13:06:38+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-19T13:09:04+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-19T13:10:03+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-19T13:10:19+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-19T13:10:42+00:00)
- `Edit` cloud/tests/test_fe_render_smoke.py (2026-07-19T13:12:44+00:00)
- `Edit` cloud/tests/test_fe_render_smoke.py (2026-07-19T13:12:52+00:00)
- `Edit` cloud/tests/test_eigenpanel.py (2026-07-19T13:13:03+00:00)
...
### at `6f00fff`
- `Edit` cloud/companion/engine_bridge.py (2026-07-20T06:21:07+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-20T06:21:18+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-20T06:21:27+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-20T06:21:32+00:00)
- `Edit` cloud/companion/app.py (2026-07-20T06:22:11+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T06:22:26+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T06:22:52+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T06:23:22+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T06:23:30+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T06:23:35+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T06:23:41+00:00)
...
### at `310b4ad`
- `Edit` cloud/companion/engine_bridge.py (2026-07-20T18:04:19+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T18:04:29+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T18:04:35+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T18:05:12+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T18:05:23+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T18:05:30+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T18:05:36+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T18:06:03+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T18:06:16+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T18:06:24+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T18:06:37+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T18:06:41+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T18:06:47+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-20T18:07:04+00:00)
...
### at `dcd8ae9`
- `Edit` cloud/companion/app.py (2026-07-24T10:24:20+00:00)

### at `bf8deb1`
- `Write` papers/PREREG-ux-login-remove-mobile.md (2026-07-24T10:31:12+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-24T10:31:22+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-24T10:31:35+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-24T10:31:45+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-24T10:31:50+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-24T10:31:57+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-24T10:32:02+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-24T10:32:11+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-24T10:32:17+00:00)
- `Edit` cloud/tests/test_fe_render_smoke.py (2026-07-24T10:32:39+00:00)

### at `9f4d269`
- `Edit` cloud/companion/static/index.html (2026-07-24T10:46:54+00:00)

### at `5cfb041`
- `Edit` cloud/companion/app.py (2026-07-24T12:05:30+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:05:37+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:05:41+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:05:45+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:06:18+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:06:25+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:06:31+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:06:38+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:06:44+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:07:00+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:07:05+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:07:14+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:07:20+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:07:29+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-24T12:08:09+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-24T12:08:38+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-24T12:08:49+00:00)
- `Write` cloud/tests/test_owner_identity_recover.py (2026-07-24T12:13:11+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:14:04+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:14:18+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:14:36+00:00)
- `Write` papers/PREREG-session-recovery.md (2026-07-24T12:17:06+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-24T12:17:46+00:00)
- `Edit` cloud/tests/test_owner_identity_recover.py (2026-07-24T12:18:46+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:22:50+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:22:56+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:23:05+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:23:12+00:00)
- `Edit` cloud/companion/app.py (2026-07-24T12:23:21+00:00)
- `Edit` papers/PREREG-session-recovery.md (2026-07-24T12:23:29+00:00)
- `Edit` papers/PREREG-session-recovery.md (2026-07-24T12:23:38+00:00)
...
### at `b8047cd`
- `Edit` cloud/companion/engine_bridge.py (2026-07-24T15:57:23+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-24T15:57:34+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-24T15:57:44+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-24T15:57:55+00:00)
- `Edit` cloud/companion/static/index.html (2026-07-24T15:58:04+00:00)

### at `895e5ec`
- `Edit` cloud/companion/engine_bridge.py (2026-07-24T17:00:53+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-24T17:01:03+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-24T17:01:19+00:00)
...
### at `a7a3e54`
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T11:52:32+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T11:52:43+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T11:53:34+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T11:53:47+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T11:53:54+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T11:54:00+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-30T11:54:15+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-30T11:54:31+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-30T11:55:08+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-30T11:55:16+00:00)
- `Edit` cloud/companion/engine_bridge.py (2026-07-30T11:55:21+00:00)
- `Edit` cloud/companion/app.py (2026-07-30T11:55:48+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T11:55:54+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T11:56:01+00:00)
- `Edit` cloud/companion/app.py (2026-07-30T11:56:06+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T11:56:08+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T11:56:16+00:00)
- `Edit` cloud/companion/app.py (2026-07-30T11:56:17+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T11:56:24+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T11:56:37+00:00)
- `Write` cloud/tests/test_wavemap_fixture.py (2026-07-30T11:57:12+00:00)
- `Write` cloud/tests/test_wavemap_fixture.py (2026-07-30T11:58:32+00:00)
- `Edit` cloud/tests/test_wavemap_fixture.py (2026-07-30T12:00:19+00:00)
- `Write` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/tests/test_waveform_scrub_fe.py (2026-07-30T12:00:37+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/tests/test_waveform_scrub_fe.py (2026-07-30T12:01:09+00:00)
- `Write` cloud/tests/test_wavemap_mapping_honesty.py (2026-07-30T12:02:09+00:00)
- `Write` cloud/tests/test_wavemap_heatmap_honesty.py (2026-07-30T12:03:50+00:00)
- `Write` cloud/tests/test_wavemap_not_a_playhead.py (2026-07-30T12:05:18+00:00)
- `Edit` cloud/tests/test_wavemap_not_a_playhead.py (2026-07-30T12:05:52+00:00)
- `Edit` cloud/tests/test_wavemap_not_a_playhead.py (2026-07-30T12:06:05+00:00)
- `Write` cloud/tests/test_wavemap_endpoint.py (2026-07-30T12:07:14+00:00)
- `Edit` cloud/tests/test_wavemap_endpoint.py (2026-07-30T12:08:01+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/tests/test_waveform_scrub_fe.py (2026-07-30T12:09:41+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/tests/test_waveform_scrub_fe.py (2026-07-30T12:10:27+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/tests/test_waveform_scrub_fe.py (2026-07-30T12:10:52+00:00)
- `Write` cloud/tools/wavemap_verify.py (2026-07-30T12:11:21+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/tests/test_waveform_scrub_fe.py (2026-07-30T12:11:47+00:00)
...
### at `a494b5b`
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T13:45:04+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T13:45:22+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T13:45:39+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T13:45:44+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T13:45:52+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T13:46:12+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T13:46:20+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T13:46:28+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T13:46:34+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T13:46:51+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/tests/test_waveform_scrub_fe.py (2026-07-30T13:47:38+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/tests/test_waveform_scrub_fe.py (2026-07-30T13:48:46+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/tests/test_waveform_scrub_fe.py (2026-07-30T13:48:59+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/tests/test_waveform_scrub_fe.py (2026-07-30T13:49:27+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/tests/test_waveform_scrub_fe.py (2026-07-30T13:50:07+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T13:50:48+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T13:51:11+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T13:51:17+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T13:51:24+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/companion/static/index.html (2026-07-30T13:51:31+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/tests/test_waveform_scrub_fe.py (2026-07-30T13:51:53+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/tests/test_waveform_scrub_fe.py (2026-07-30T13:52:11+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/tests/test_waveform_scrub_fe.py (2026-07-30T13:52:27+00:00)
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/tests/test_waveform_scrub_fe.py (2026-07-30T13:52:50+00:00)

### at `30a555b`
- `Edit` .claude/worktrees/agent-a6098a0e9a5b02f14/cloud/tests/test_waveform_scrub_fe.py (2026-07-30T13:55:23+00:00)
...
### at `2d925e9`
- `Edit` .claude/worktrees/agent-a8c280d7f18abbdeb/cloud/companion/static/index.html (2026-08-14T14:06:15+00:00)
- `Edit` .claude/worktrees/agent-ae6cde3a84b712739/cloud/companion/engine_bridge.py (2026-08-14T14:06:15+00:00)
- `Edit` .claude/worktrees/agent-ae6cde3a84b712739/cloud/companion/engine_bridge.py (2026-08-14T14:06:21+00:00)
- `Edit` .claude/worktrees/agent-a8c280d7f18abbdeb/cloud/companion/static/index.html (2026-08-14T14:06:30+00:00)
- `Edit` .claude/worktrees/agent-a8c280d7f18abbdeb/cloud/companion/static/index.html (2026-08-14T14:06:43+00:00)
- `Edit` .claude/worktrees/agent-a8c280d7f18abbdeb/cloud/companion/static/index.html (2026-08-14T14:06:47+00:00)
- `Edit` .claude/worktrees/agent-ae6cde3a84b712739/cloud/companion/engine_bridge.py (2026-08-14T14:07:01+00:00)
- `Edit` .claude/worktrees/agent-a8c280d7f18abbdeb/cloud/companion/static/index.html (2026-08-14T14:07:09+00:00)
- `Edit` .claude/worktrees/agent-a8c280d7f18abbdeb/cloud/companion/static/index.html (2026-08-14T14:07:16+00:00)
- `Edit` .claude/worktrees/agent-a8c280d7f18abbdeb/cloud/companion/static/index.html (2026-08-14T14:07:20+00:00)
- `Edit` .claude/worktrees/agent-ae6cde3a84b712739/cloud/companion/engine_bridge.py (2026-08-14T14:07:22+00:00)
- `Edit` .claude/worktrees/agent-ae6cde3a84b712739/cloud/companion/engine_bridge.py (2026-08-14T14:07:27+00:00)
- `Edit` .claude/worktrees/agent-ae6cde3a84b712739/cloud/companion/app.py (2026-08-14T14:07:51+00:00)
- `Edit` .claude/worktrees/agent-a8c280d7f18abbdeb/cloud/companion/static/index.html (2026-08-14T14:07:52+00:00)
- `Edit` .claude/worktrees/agent-a8c280d7f18abbdeb/cloud/companion/static/index.html (2026-08-14T14:08:03+00:00)
...
### at `cbc8f2d`
- `Edit` .claude/worktrees/agent-ad3d0fbca1cd43b88/cloud/companion/static/index.html (2026-08-14T18:13:00+00:00)
- `Edit` .claude/worktrees/agent-ad3d0fbca1cd43b88/cloud/companion/static/index.html (2026-08-14T18:13:02+00:00)
- `Edit` .claude/worktrees/agent-ad3d0fbca1cd43b88/cloud/companion/static/index.html (2026-08-14T18:13:04+00:00)
- `Edit` .claude/worktrees/agent-ad3d0fbca1cd43b88/cloud/companion/static/index.html (2026-08-14T18:13:07+00:00)
- `Edit` .claude/worktrees/agent-ad3d0fbca1cd43b88/cloud/companion/static/index.html (2026-08-14T18:13:09+00:00)
- `Write` .claude/worktrees/agent-ad3d0fbca1cd43b88/cloud/tests/test_live_view_no_threshold.py (2026-08-14T18:13:28+00:00)
- `Edit` .claude/worktrees/agent-ac8dff5b092aee9c5/papers/PREREG-live-mode.md (2026-08-14T18:14:12+00:00)
- `Edit` .claude/worktrees/agent-ac8dff5b092aee9c5/LEDGER_DATA.json (2026-08-14T18:15:42+00:00)
- `Edit` .claude/worktrees/agent-ac8dff5b092aee9c5/LEDGER.md (2026-08-14T18:16:09+00:00)
- `Write` .claude/worktrees/agent-a1f0ac7a43ba871a5/cloud/tools/b1_release_admission_measure.py (2026-08-14T18:16:55+00:00)
- `Write` .claude/worktrees/agent-adb3c5395b2c41116/cloud/tests/test_live_bridge.py (2026-08-14T18:17:08+00:00)
- `Edit` .claude/worktrees/agent-adb3c5395b2c41116/cloud/tests/test_live_bridge.py (2026-08-14T18:17:31+00:00)
...
### at `ff9aadf`
- `Edit` .claude/worktrees/agent-ac318733a75fe6913/cloud/companion/static/index.html (2026-08-14T19:10:07+00:00)
- `Edit` .claude/worktrees/agent-ac318733a75fe6913/cloud/companion/static/index.html (2026-08-14T19:10:09+00:00)

### at `c3fac85`
- `Edit` .claude/worktrees/agent-ac318733a75fe6913/cloud/tools/track_role_grid_verify.py (2026-08-14T19:13:23+00:00)
- `Write` .claude/worktrees/agent-a4f9038da3e833bf2/scripts/build_ledger.py (2026-08-14T19:13:53+00:00)
- `Write` .claude/worktrees/agent-a4f9038da3e833bf2/tests/tools/test_build_ledger.py (2026-08-14T19:15:06+00:00)
- `Edit` .claude/worktrees/agent-a4f9038da3e833bf2/tests/tools/test_build_ledger.py (2026-08-14T19:15:17+00:00)
- `Write` .claude/worktrees/agent-ac318733a75fe6913/papers/FINDING-column-lean-region-disarmed-corpus.md (2026-08-14T19:15:40+00:00)
- `Edit` .claude/worktrees/agent-ac318733a75fe6913/papers/PREREG-waveform-scrub.md (2026-08-14T19:15:48+00:00)
- `Edit` .claude/worktrees/agent-ac318733a75fe6913/LEDGER_DATA.json (2026-08-14T19:16:34+00:00)
- `Edit` .claude/worktrees/agent-ac318733a75fe6913/LEDGER.md (2026-08-14T19:17:22+00:00)
- `Write` .claude/worktrees/agent-a7911ee17c089e01f/cloud/tools/b1_release_scope_verify.py (2026-08-14T19:17:29+00:00)
- `Edit` .claude/worktrees/agent-adde4fa0f4f9ca80a/architecture-v6/ets/writer/clamp.py (2026-08-14T19:17:55+00:00)
- `Write` .claude/worktrees/agent-a7911ee17c089e01f/cloud/tools/_debug_br_journey.py (2026-08-14T19:18:00+00:00)
- `Edit` .claude/worktrees/agent-adde4fa0f4f9ca80a/architecture-v6/ets/writer/clamp.py (2026-08-14T19:18:14+00:00)
- `Edit` .claude/worktrees/agent-adde4fa0f4f9ca80a/architecture-v6/ets/writer/realize.py (2026-08-14T19:18:22+00:00)
- `Edit` .claude/worktrees/agent-adde4fa0f4f9ca80a/cloud/companion/live.py (2026-08-14T19:18:42+00:00)
- `Write` .claude/worktrees/agent-a7911ee17c089e01f/cloud/tools/_debug_br_internals.py (2026-08-14T19:19:06+00:00)
- `Edit` .claude/worktrees/agent-adde4fa0f4f9ca80a/cloud/companion/live.py (2026-08-14T19:19:10+00:00)
- `Edit` .claude/worktrees/agent-adde4fa0f4f9ca80a/cloud/companion/live.py (2026-08-14T19:19:16+00:00)
- `Edit` .claude/worktrees/agent-a7911ee17c089e01f/cloud/tools/_debug_br_internals.py (2026-08-14T19:19:17+00:00)
- `Edit` .claude/worktrees/agent-a7911ee17c089e01f/cloud/tools/_debug_br_internals.py (2026-08-14T19:19:20+00:00)
- `Edit` .claude/worktrees/agent-adde4fa0f4f9ca80a/cloud/companion/live.py (2026-08-14T19:19:37+00:00)

### at `29c092e`
- `Edit` .claude/worktrees/agent-adde4fa0f4f9ca80a/cloud/companion/engine_bridge.py (2026-08-14T19:19:55+00:00)
