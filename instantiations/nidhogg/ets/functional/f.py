...
# INSTANTIATION: nidhogg (deep/atmospheric halftime corpus, 25 tracks). These
# weights were emitted by this fork's scripts/run_training.py NCE separation exam
# on the nidhogg corpus (held-out min sep 0.98 >= 0.90 = PASS; all four scramble
# families separate). Distinct from the v1/jörmungandr weights by design — same F
