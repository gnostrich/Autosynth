...
# INSTANTIATION: futuregarage (deep/atmospheric halftime corpus, 25 tracks). These
# weights were emitted by this fork's scripts/run_training.py NCE separation exam
# on the futuregarage corpus (held-out min sep 0.98 >= 0.90 = PASS; all four scramble
# families separate). Distinct from the v1/psytech weights by design — same F
# structure, genre-specific fit. Regenerate: run this fork's run_training.py.
LAMBDA = {"T2": 5.032823194421518, "T3": 1.0209148623852349,
          "T4": 10.817367934599108, "T5": 0.1, "T1p": 8.868646981570928}
